...
role :holidays do
  ...
  role :enter_results  do
    ...
    has_permission_on [:homework],
        :to => [
        :index,
        :create_homework,
        :update_batch,
        :homework_wise_report,
        :list_homework_types,
        :generated_report,
        :graph_for_generated_report,
        :generated_report_pdf,
        :consolidated_homework_report,
        :consolidated_homework_report_pdf,
        :subject_wise_report,
        :list_subjects,
        :generated_report2,
        :generated_report2_pdf,
        :grouped_homework_report,
        :final_report_type,
        :generated_report4,
        :generated_report4_pdf
        ]
        has_permission_on [:homework_groups],
        :to => [
        :index,
        :show,
        :set_homework_minimum_marks,
        :set_homework_maximum_marks,
        :set_homework_weightage,
        :set_homework_group_name
        ]
        has_permission_on [:homeworks],
        :to => [
        :index,
        :show,
        :save_scores,
  ...
  role :view_results  do
    ...
    has_permission_on [:exam], :to => [:index,
      ...
      :combined_grouped_exam_report_pdf
            ...
            has_permission_on [:homework], :to => [:index,
            :homework_wise_report,
            :list_homework_types,
            :generated_report,
            :graph_for_generated_report,
        ...
        has_permission_on [:homework_result],
          :to => [
            :load_results,
            :load_one_sub_result,
            :load_all_sub_result,
            :update_homeworktypes,
            :update_subjects,
            :update_one_subject,
            :update_homeworks,
            :update_one_sub_homeworks,
            :one_sub_pdf,
            :all_sub_pdf,
            :view_all_subs,
            :view_one_sub ]
  ...
  role :manage_journal do
      has_permission_on [:journal],
        :to => [
          :index,
          :add,
          :add_comment,
  ...
  role :manage_laurel do
    has_permission_on [:laurel],
      :to => [
        :index,
        :add,
        :add_comment,
...
#      :additional_fees_delete,
 ...
 role :todays_thought do
    has_permission_on [:thoughts],
      :to => [
        :index,
        :edit,
        :update ]
  ...
  role :admin do
    ...
    has_permission_on :certificates,
      :to => [
        :display,
        ...
        :select,
        :take_call,
        :list_of_student_ajax,
        :list_of_employee_ajax,
        :birth_certificate

      ]
    has_permission_on [:reader], :to => [:index]  
...
#      :additional_fees_delete,
  ...
  role :student do
    ...
    has_permission_on [:thoughts],
      :to => [ :index ]
    has_permission_on [:holidays], :to => [ :index ]
     has_permission_on [:homework], :to => [:generated_report, :generated_report4_pdf, :graph_for_generated_report, :academic_report, :previous_years_marks_overview, :graph_for_previous_years_marks_overview, :generated_report3, :graph_for_generated_report3 ,:generated_report4]
     has_permission_on [:homework_result],  
         :to => [
            :load_results,
            :load_one_sub_result,
