...
class Employee < ActiveRecord::Base
  ...
  def age
    year = date_of_birth.strftime "%Y" rescue nil
    if year
      today_year = Date.today.strftime "%Y"
      return (today_year.to_i - year.to_i)
    else
      return ".............."
    end  
  end  
  ...
  def address
    full_address = "................."
    if home_address_line1 or home_address_line2
      full_address = (home_address_line1 || "") + (home_address_line2 || "") + (home_city || "")+ (home_state || "") + (home_country || "")
    end 
    full_address 
  end  
end
