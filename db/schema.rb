...
ActiveRecord::Schema.define(:version => 20121221053337) do
  ...
  add_index "batches", ["course_id", "name"], :name => "index_batches_on_course_id_and_name"
  ...
  add_index "book_movements", ["school_id"], :name => "index_book_movements_on_school_id"
  ...
  add_index "book_reservations", ["school_id"], :name => "index_book_reservations_on_school_id"
  ...
  create_table "bus_services", :force => true do |t|
    ...
    t.string   "gps_unit_no"
    t.string   "gprs_sim_no"
    t.boolean  "status"
    t.integer  "reader_id"
  end

  create_table "bus_settings", :force => true do |t|
  ...
  create_table "investitures", :force => true do |t|
    t.string   "title"
    t.text     "summary"
    t.text     "description"
    t.datetime "created_at"
  ...
  create_table "laurels", :force => true do |t|
    t.string   "title"
    t.text     "summary"
    t.text     "description"
    t.datetime "created_at"
  ...
  add_index "library_card_settings", ["school_id"], :name => "index_library_card_settings_on_school_id"
  ...
  create_table "rooms", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "room_occupied",    :default => 0
  end
  ...
  create_table "school_logos", :force => true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "logo_file_name"
    t.string   "logo_content_type"
  ...
  create_table "students", :force => true do |t|
    ...
    t.integer  "route_id"
    t.integer  "room_id"
    t.boolean  "bus_fee_paid",         :default => false
    t.boolean  "hostel_fee_paid",      :default => false
    t.string   "caste"
    t.integer  "RFID_tag_id"
    t.string   "library_card"
  end
  ...
  add_index "taggings", ["school_id"], :name => "index_taggings_on_school_id"
  ...
  add_index "tags", ["school_id"], :name => "index_tags_on_school_id"
